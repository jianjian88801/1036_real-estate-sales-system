          ...
          <el-form-item class="input" label="房源类型" prop="fangyuanleixing">
              <el-input v-model="ruleForm.fangyuanleixing" 
                placeholder="房源类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="房源户型" prop="fangyuanhuxing">
          <el-input v-model="ruleForm.fangyuanhuxing" 
              placeholder="房源户型" clearable  :readonly="ro.fangyuanhuxing"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jiaoyidingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiaoyidingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
