  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(247, 240, 240, 0.7);borderRadius:10px">
        <h1 class="h1" style="color:#000;fontSize:28px;">房产销售系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
																																										...
																																										<!-- <div v-if="tableName=='xiaoshoujingli'" class="input-group">
			   <div class="label">销售账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xiaoshouzhanghao" class="input" type="text" placeholder="销售账号">
			   </div>
			 </div> -->
			<el-form-item label="销售账号" class="input" v-if="tableName=='xiaoshoujingli'">
			  <el-input v-model="ruleForm.xiaoshouzhanghao" autocomplete="off" placeholder="销售账号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='xiaoshoujingli'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='xiaoshoujingli'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='xiaoshoujingli'" class="input-group">
			   <div class="label">销售姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xiaoshouxingming" class="input" type="text" placeholder="销售姓名">
			   </div>
			 </div> -->
			<el-form-item label="销售姓名" class="input" v-if="tableName=='xiaoshoujingli'">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='xiaoshoujingli'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='xiaoshoujingli'" class="input-group">
			   <div class="label">销售手机</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xiaoshoushouji" class="input" type="text" placeholder="销售手机">
			   </div>
			 </div> -->
			<el-form-item label="销售手机" class="input" v-if="tableName=='xiaoshoujingli'">
			  <el-input v-model="ruleForm.xiaoshoushouji" autocomplete="off" placeholder="销售手机" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='xiaoshoujingli'" class="input-group">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='xiaoshoujingli'">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                                                                                                                        ...
                                                                                                                                                                        if((!this.ruleForm.xiaoshouzhanghao) && `xiaoshoujingli` == this.tableName){
        this.$message.error(`销售账号不能为空`);
        return
      }
                                                                  if((!this.ruleForm.mima) && `xiaoshoujingli` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                                                                                                                                                                                                                                        if(`xiaoshoujingli` == this.tableName && this.ruleForm.shenfenzheng&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzheng))){
        this.$message.error(`身份证应输入身份证格式`);
        return
      }
                                                      if(`xiaoshoujingli` == this.tableName && this.ruleForm.xiaoshoushouji&&(!this.$validate.isMobile(this.ruleForm.xiaoshoushouji))){
        this.$message.error(`销售手机应输入手机格式`);
        return
      }
                                                                                                                                                                                                      this.$http({
